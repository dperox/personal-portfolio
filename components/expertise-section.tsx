      ...
      <div className="grid gap-4 pt-2 md:grid-cols-2 lg:grid-cols-3">
        {skills.map((skill, index) => {
          ...
          return (
            <div
              key={index}
              className="group space-y-3 rounded-2xl border border-[color:var(--panel-border)] bg-gradient-to-br from-black/20 to-transparent p-4 transition-all hover:scale-105 hover:border-opacity-60 hover:shadow-[0_8px_32px_rgba(0,0,0,0.3)] dark:from-white/5"
              style={{
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-mono text-sm font-semibold text-[color:var(--fg)]">{skill.title}</h3>
              </div>
